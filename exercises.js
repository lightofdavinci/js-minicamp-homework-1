...
/*
 ...
 Strings are like sentences. They are formed by a list of characters.
 Strings are very useful when communicating information from the program to the user of the program.
 Strings are almost always written in code as a quoted sequence of characters.
 ...
 If value to return omitted, it returns undefined
...
function square(num) {
  ...
  // code here
  return num * num; // or Math.pow(num, 2);
}
